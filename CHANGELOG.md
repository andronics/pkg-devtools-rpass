...
All notable changes to @devtools/rpass will be documented in this file.
...
- Declared external command requirements: dmenu, gpg
...
- Package naming now includes collection scope: `@devtools/rpass`
