# rpass - AI Assistant Instructions

**Package**: `@devtools/rpass`
**Version**: 0.1.0
**Type**: devtools package

## Package Overview

**Description**: Password Manager - Remote password storage and retrieval

**Purpose**: Provide password manager - remote password storage and retrieval functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/rpass` - Main executable
...
1. **Test installation**: `stow rpass`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D rpass`
